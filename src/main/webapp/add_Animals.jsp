...
<body>
  ...
  <div class="py-5" style="	background-image: url(https://cdn.wallpapersafari.com/19/43/DJHM7R.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-light">Add an animal to the database</h1>
        </div>
      </div>
    </div>
  </div>
  <div class="py-1" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">        
          <form action="AnimalsController" method="GET">
            <div class="form-group"> <label>Name</label> <input type="text" class="form-control" placeholder="Enter animal name" name="nume"> </div>
            <div class="form-group"> <label>Region</label> <input type="text" class="form-control" placeholder="Enter the region of the animal" name = "prenume"> </div>
            <input type="submit" name="adaugaPacient" class="btn btn-primary" value="Add animal">                 
          </form>
          <div class="form-group">
          <form action="AnimalsController" method="POST">
            <input type="submit" class="btn btn-primary" name="afiseazaPacienti" value="Show animals database"> &nbsp; &nbsp;<br>
        </form>
        </div>
        </div>
      </div>
